...
trait IntegrationTestConfigurations {
     ...
     */
    def scalaTestConfiguration = Array(mavenBundle("org.apache.servicemix.bundles", "org.apache.servicemix.bundles.scala-library").versionAsInProject())
    ...
    def servicemixTestConfiguration(variant: String = null) = {
        ...
        val jetpackFeaturesUrl = maven().groupId("pl.reintegrate.jetpack").artifactId("jetpack-core").`type`("xml").classifier("features").versionAsInProject().getURL();
        ...
        Array(
            ...
            editConfigurationFileExtend("etc/org.apache.karaf.features.cfg", "featuresRepositories", "," + jetpackFeaturesUrl),
            vmOption("-Xmx2048m -XX:MaxPermSize=1024m")
